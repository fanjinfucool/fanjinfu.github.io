...
- ``Neurocomputing`` **Jinfu Fan**，Jiangnan Li, Wenpeng Lu, Linqing Huang. Partial Multi-Label Learning via Transformer to Discover Discriminative Label Embeddings.<font color="blue"> Neurocomputing </font> (**2024-IF: 6.5**), 2026. [[PDF](https://github.com/fanjinfucool/fanjinfu.github.io/blob/main/docs/PML-TF.pdf)]
